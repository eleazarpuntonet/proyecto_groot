      ...
      <b-col md="12">
        <b-card header="Traffic &amp; Sales">
          ...
          <b-table class="mb-0 table-outline" responsive="sm" hover :items="tableItems" :fields="tableFields" head-variant="light">
            <div slot="avat" class="avatar" slot-scope="item">
...
export default {
  ...
  data: function () {
    return {
      ...
      tableItems: [
        {
          avat: { url: 'img/avatars/1.jpg', status: 'success' },
        ...
        {
          avat: { url: 'img/avatars/2.jpg', status: 'danger' },
        ...
        {
          avat: { url: 'img/avatars/3.jpg', status: 'warning' },
        ...
        {
          avat: { url: 'img/avatars/4.jpg', status: '' },
        ...
        {
          avat: { url: 'img/avatars/5.jpg', status: 'success' },
        ...
        {
          avat: { url: 'img/avatars/6.jpg', status: 'danger' },
